 ...
 *   <li>each extra fields starts by a two byte header openid followed by
...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
    ...
    /**
     * Creates a new org.apache.tools.zip entry with the specified name.
     *
    ...
    /**
     * Creates a new org.apache.tools.zip entry with fields taken from the specified org.apache.tools.zip entry.
     *
     * <p>Assumes the entry represents a directory if and only if the
     * name ends with a forward slash "/".</p>
     *
    ...
    /**
     * Creates a new org.apache.tools.zip entry taking some information from the given
    ...
    /**
     * Looks up an extra field by its header openid.
     *
