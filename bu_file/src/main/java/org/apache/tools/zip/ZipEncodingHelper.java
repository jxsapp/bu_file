...
/**
 * Static helper functions for robustly encoding filenames in org.apache.tools.zip files. 
 */
public abstract class ZipEncodingHelper {
    ...
    /**
     * Instantiates a org.apache.tools.zip encoding.
     * 
     * @param name The name of the org.apache.tools.zip encoding. Specify {@code null} for
     *             the platform's default encoding.
     * @return A org.apache.tools.zip encoding for the given encoding name.
     */
